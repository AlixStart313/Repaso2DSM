        ...
        <View >
            <View style={{
                ...
                <View style={{ marginRight: 120 }}>
                    <Text >Joel Alejandro Herrera</Text>
            ...
            <View  >
                ...
                <View>
                    <Text style={{ fontSize: 12, marginLeft:20 }}>3,200 Me gusta</Text>
                    <Text style={{ fontSize: 15, marginLeft:20 , marginTop:3 }}><Text style={{fontWeight:"bold"}}>AlexxJoel:</Text> El perrito loco</Text>
